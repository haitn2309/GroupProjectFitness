...
/*const CaloriesPopUp = ({ show, handleClose, adjustCalories }) => {
  return (
    <div>
...
const CaloriesPopUp = ({ show, handleClose, calculateBMIandBMR, gender, activityLevel, adjustCalories }) => {
  const getTDEE = () => {
